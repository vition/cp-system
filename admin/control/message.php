<?php 
	...
	switch($_POST["type"]){
		...
		<div class="mes-search-div"><span class="read-ico search-ico" data-state="read"></span><span class="unread-ico search-ico" data-state="unread"></span><input id="read-state" type="hidden" value="0"></div>
